...
public:
    ...
    // Optional mesh-derived compound collision used when an inventory visual
    // has no authored OGF bone shapes.
    virtual bool PHUseAutoGeneratedCollision() const { return false; }
    virtual bool PHForceAutoGeneratedCollision() const { return false; }
    virtual float PHCollisionVisualScale() const { return 1.f; }
    virtual u32 PHAutoCollisionMaxBoxes() const { return 1; }
