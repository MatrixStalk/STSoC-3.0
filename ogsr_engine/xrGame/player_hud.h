...
struct player_hud_motion_container
{
    ...
    void load(bool has_separated_hands, bool merge_skeleton, IKinematicsAnimated* model, IKinematicsAnimated* animatedHudItem, const shared_str& sect);
};
...
public:
    ...
    // The item owns animations for the complete Source rig. Matching bones of
    // the replaceable hands mesh are driven from this skeleton by name.
    bool m_merge_skeleton{};
...
public:
    ...
    u32 anim_play(u16 part, const motion_params& P, const motion_descr& M, BOOL bMixIn, const CMotionDef*& md, float speed, bool hasHands,
        bool mergeSkeleton, IKinematicsAnimated* itemModel = nullptr);
    ...
    // Movement animation layers: 0 = aim_walk, 1 = aim_crouch, 2 = crouch,
    // 3 = walk, 4 = run, 5 = sprint, 6 = aim_idle, 7 = idle
    ...
    player_hud_motion_container* get_hand_motions(LPCSTR section, IKinematicsAnimated* animatedHudItem, bool merge_skeleton = false);
...
private:
    ...
    static void SourceBoneMergeCallback0(CBoneInstance* B);
